...
//porinho
const porinhoTexture = new THREE.TextureLoader().load('public/assets/porinho.jpg');
...
scene.add(porinho);
//mars
const marsTexture = new THREE.TextureLoader().load('public/assets/mars.jpg');
const normalTexture = new THREE.TextureLoader().load('public/assets/mars-normal.jpg');
